...
local servers = {
    ansiblels = defaultLspSetup,

    bashls = defaultLspSetup,

    cmake = defaultLspSetup,

    cssls = defaultLspSetup,

    cssmodules_ls = defaultLspSetup,

    cucumber_language_server = defaultLspSetup,

    dockerls = defaultLspSetup,

    groovyls = defaultLspSetup,
    ...
    jdtls = {
        ...
        settings = {
            ...
            ["java.format.settings.url"] = vim.fs.normalize("$HOME/GBPrime/backoffice/google_formatter.xml"),
    ...
    jsonls = defaultLspSetup,

    pyright = defaultLspSetup,

    rome = defaultLspSetup,

    sqls = defaultLspSetup,
...
for _, lsp in ipairs(mason_lsp.get_installed_servers()) do
